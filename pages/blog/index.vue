                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <NuxtLink class="theme-btn" to="blog/aksdfhaskdjfh">Read More<i class="fas fa-arrow-right-long"></i></NuxtLink>
                                <!-- <a class="theme-btn" href="blog/aksdfhaskdjfh">Read More<i class="fas fa-arrow-right-long"></i></a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
